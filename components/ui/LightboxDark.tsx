  ...
  const AnimatedImage: React.FC<AnimatedImageProps> = ({ src, alt }) => {
    return (
      <motion.div
        ...
        className="absolute rounded-xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
      >
        <div
          className="flex items-center justify-center max-w-full max-h-full w-[90vw] h-[90vh] overflow-hidden bg-black rounded-xl"
